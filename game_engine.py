...
def init(resolution=[], title='Game by Game04'):
...
class Text(Label):
    def __init__(self,text="",position=(400,300),font_size=24,italic=True,color=(255,0,0,128)):
    
        super().__init__(text,position,font_size= font_size, italic=italic ,color=color)
